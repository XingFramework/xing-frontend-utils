import SerializerModule from '../src/xing-frontend-utils/serializer.js';
import {bootstrap} from "a1atscript";

describe('serializer', function () {
    'use strict';
    beforeEach(function() {
        bootstrap(SerializerModule);
    });
    ...
    describe('provider config', function () {
        it('should allow overriding underscore method', function () {
            ...
            angular.mock.module(`serializer`, function (SerializerProvider) {
    ...
    describe('default provider options', function () {
        ...
        beforeEach(angular.mock.module(`serializer`));
